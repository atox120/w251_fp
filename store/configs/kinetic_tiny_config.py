...
print(swin_tiny_path)
print(runtime_path)

_base_ = [swin_tiny_path, runtime_path]
...
ann_file_train = data_root + '/kinetics_tiny_train_video.txt'
ann_file_val = data_root + '/kinetics_tiny_val_video.txt'
